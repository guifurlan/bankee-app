 ...
 * 
 * https://github.com/rationalappdev/onboarding/
 */
...
import Button from './SwiperButton';
    ...
    return (
      <View pointerEvents="box-none" style={[styles.buttonWrapper, styles.fullScreen]}>
        {lastScreen
          ...
          ? <Button text="Ok" onPress={() => this.props.continue()} />
          // Or this one otherwise
          : <Button text="Pular" onPress={() => this.props.skip()} />
        }
      </View>
    );
  }
